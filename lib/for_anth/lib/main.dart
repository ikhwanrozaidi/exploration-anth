...
void main() {
  ...
  runApp(
    MultiBlocProvider(
      providers: [
        BlocProvider<LocaleBloc>(create: (context) => getIt<LocaleBloc>()..add(const LoadSavedLocale()),),
        ...
        //  BlocProvider<TransactionboardBloc>(
        //     create: (context) => getIt<TransactionboardBloc>(),
        //     lazy: true,
        //   ),
