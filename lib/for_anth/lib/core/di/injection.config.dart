...
import '../../features/auth/data/datasources/auth_remote_data_source.dart'
    as _i107;
import '../../features/auth/data/datasources/login_api_service.dart' as _i281;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i336.LoginLocalDataSource>(
      () => _i336.LoginLocalDataSourceImpl(gh<_i982.DatabaseService>()),
    );
    ...
    gh.factory<_i281.LoginApiService>(
      () => _i281.LoginApiService(gh<_i361.Dio>()),
    );
    gh.lazySingleton<_i852.AuthLocalDataSource>(
      () => _i852.AuthLocalDataSourceImpl(gh<_i982.DatabaseService>()),
    );
    gh.lazySingleton<_i140.LoginRemoteDataSource>(
      () => _i140.LoginRemoteDataSourceImpl(gh<_i281.LoginApiService>()),
    );
    gh.lazySingleton<_i908.AuthInterceptor>(
      () => _i908.AuthInterceptor(
        gh<_i336.LoginLocalDataSource>(),
        gh<_i140.LoginRemoteDataSource>(),
      ),
    );
    ...
    gh.lazySingleton<_i188.LoginUseCase>(
      () => registerModule.loginUseCase(gh<_i870.LoginRepository>()),
    );
    gh.lazySingleton<_i188.LogoutUseCase>(
      () => registerModule.logoutUseCase(gh<_i870.LoginRepository>()),
    );
    gh.lazySingleton<_i188.GetStoredAdminUseCase>(
      () => registerModule.getStoredAdminUseCase(gh<_i870.LoginRepository>()),
    );
    gh.lazySingleton<_i188.RefreshTokenUseCase>(
      () => registerModule.refreshTokenUseCase(gh<_i870.LoginRepository>()),
    );
    ...
    gh.lazySingleton<_i990.LoginBloc>(
      () => _i990.LoginBloc(
        gh<_i188.LoginUseCase>(),
        gh<_i188.LogoutUseCase>(),
        gh<_i188.GetStoredAdminUseCase>(),
    ...
    gh.lazySingleton<_i57.SignUpUseCase>(
      () => registerModule.signUpUseCase(gh<_i787.AuthRepository>()),
    );
    gh.lazySingleton<_i57.CheckEmailExistsUseCase>(
      () => registerModule.checkEmailExistsUseCase(gh<_i787.AuthRepository>()),
    );
