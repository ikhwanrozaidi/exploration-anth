...
@override
String toString() {
  return 'CountryModel(id: $id, uid: $uid, name: $name, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
class _CountryModel extends CountryModel {
  const _CountryModel({this.id, this.uid, this.name, this.createdAt, this.updatedAt}): super._();
