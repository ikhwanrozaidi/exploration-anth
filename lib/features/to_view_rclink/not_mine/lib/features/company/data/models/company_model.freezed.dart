...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,uid,name,regNo,cidbNo,address,postalCode,city,state,country,phone,email,website,companyType,bumiputera,einvoiceTinNo,registrationDate,createdAt,updatedAt,deletedAt,ownerID,adminRole,adminCount]);

@override
String toString() {
  return 'CompanyModel(id: $id, uid: $uid, name: $name, regNo: $regNo, cidbNo: $cidbNo, address: $address, postalCode: $postalCode, city: $city, state: $state, country: $country, phone: $phone, email: $email, website: $website, companyType: $companyType, bumiputera: $bumiputera, einvoiceTinNo: $einvoiceTinNo, registrationDate: $registrationDate, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, ownerID: $ownerID, adminRole: $adminRole, adminCount: $adminCount)';
}
...
switch (_that) {
case _CompanyModel() when $default != null:
return $default(_that.id,_that.uid,_that.name,_that.regNo,_that.cidbNo,_that.address,_that.postalCode,_that.city,_that.state,_that.country,_that.phone,_that.email,_that.website,_that.companyType,_that.bumiputera,_that.einvoiceTinNo,_that.registrationDate,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.ownerID,_that.adminRole,_that.adminCount);case _:
  return orElse();
