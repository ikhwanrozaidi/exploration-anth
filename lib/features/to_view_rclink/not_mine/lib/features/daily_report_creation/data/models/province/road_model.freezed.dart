...
mixin _$RoadModel {
 ...
 int? get id; String? get uid; String? get name; String? get roadNo; String? get sectionStart; String? get sectionFinish;@JsonKey(name: 'mainCategoryID') int? get mainCategoryId;@JsonKey(name: 'secondaryCategoryID') int? get secondaryCategoryId;@JsonKey(name: 'districtID') int? get districtId; String? get createdAt; String? get updatedAt; DistrictModel? get district; RoadCategoryModel? get mainCategory; RoadCategoryModel? get secondaryCategory;
...
@useResult
$Res call({
 int? id, String? uid, String? name, String? roadNo, String? sectionStart, String? sectionFinish,@JsonKey(name: 'mainCategoryID') int? mainCategoryId,@JsonKey(name: 'secondaryCategoryID') int? secondaryCategoryId,@JsonKey(name: 'districtID') int? districtId, String? createdAt, String? updatedAt, DistrictModel? district, RoadCategoryModel? mainCategory, RoadCategoryModel? secondaryCategory
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? uid,  String? name,  String? roadNo,  String? sectionStart,  String? sectionFinish, @JsonKey(name: 'mainCategoryID')  int? mainCategoryId, @JsonKey(name: 'secondaryCategoryID')  int? secondaryCategoryId, @JsonKey(name: 'districtID')  int? districtId,  String? createdAt,  String? updatedAt,  DistrictModel? district,  RoadCategoryModel? mainCategory,  RoadCategoryModel? secondaryCategory)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RoadModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? uid,  String? name,  String? roadNo,  String? sectionStart,  String? sectionFinish, @JsonKey(name: 'mainCategoryID')  int? mainCategoryId, @JsonKey(name: 'secondaryCategoryID')  int? secondaryCategoryId, @JsonKey(name: 'districtID')  int? districtId,  String? createdAt,  String? updatedAt,  DistrictModel? district,  RoadCategoryModel? mainCategory,  RoadCategoryModel? secondaryCategory)  $default,) {final _that = this;
switch (_that) {
case _RoadModel():
return $default(_that.id,_that.uid,_that.name,_that.roadNo,_that.sectionStart,_that.sectionFinish,_that.mainCategoryId,_that.secondaryCategoryId,_that.districtId,_that.createdAt,_that.updatedAt,_that.district,_that.mainCategory,_that.secondaryCategory);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? uid,  String? name,  String? roadNo,  String? sectionStart,  String? sectionFinish, @JsonKey(name: 'mainCategoryID')  int? mainCategoryId, @JsonKey(name: 'secondaryCategoryID')  int? secondaryCategoryId, @JsonKey(name: 'districtID')  int? districtId,  String? createdAt,  String? updatedAt,  DistrictModel? district,  RoadCategoryModel? mainCategory,  RoadCategoryModel? secondaryCategory)?  $default,) {final _that = this;
switch (_that) {
case _RoadModel() when $default != null:
return $default(_that.id,_that.uid,_that.name,_that.roadNo,_that.sectionStart,_that.sectionFinish,_that.mainCategoryId,_that.secondaryCategoryId,_that.districtId,_that.createdAt,_that.updatedAt,_that.district,_that.mainCategory,_that.secondaryCategory);case _:
  return null;
...
class _RoadModel implements RoadModel {
   _RoadModel({this.id, this.uid, this.name, this.roadNo, this.sectionStart, this.sectionFinish, @JsonKey(name: 'mainCategoryID') this.mainCategoryId, @JsonKey(name: 'secondaryCategoryID') this.secondaryCategoryId, @JsonKey(name: 'districtID') this.districtId, this.createdAt, this.updatedAt, this.district, this.mainCategory, this.secondaryCategory});
...
@override@JsonKey(name: 'mainCategoryID') final  int? mainCategoryId;
@override@JsonKey(name: 'secondaryCategoryID') final  int? secondaryCategoryId;
@override@JsonKey(name: 'districtID') final  int? districtId;
