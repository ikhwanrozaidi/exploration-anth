...
part of 'quantity_field.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

QuantityField _$QuantityFieldFromJson(Map<String, dynamic> json) =>
    QuantityField(
...
Map<String, dynamic> _$QuantityFieldToJson(QuantityField instance) =>
    <String, dynamic>{
      'id': instance.id,
      'uid': instance.uid,
      'name': instance.name,
