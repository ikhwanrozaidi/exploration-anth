...
return equipmentsFailure(_that);case DailyReportUpdating() when updating != null:
return updating(_that);case DailyReportUpdateSuccess() when updateSuccess != null:
return updateSuccess(_that);case DailyReportUpdateFailure() when updateFailure != null:
...
return equipmentsFailure(_that);case DailyReportUpdating():
return updating(_that);case DailyReportUpdateSuccess():
return updateSuccess(_that);case DailyReportUpdateFailure():
return updateFailure(_that);case _:
...
return equipmentsFailure(_that.message);case DailyReportUpdating() when updating != null:
return updating();case DailyReportUpdateSuccess() when updateSuccess != null:
return updateSuccess(_that.report);case DailyReportUpdateFailure() when updateFailure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<DailyReportResponse> reports)  loaded,required TResult Function( String message)  failure,required TResult Function()  roadsLoading,required TResult Function( List<RoadEdit> roads,  RoadEdit? selectedRoad,  String? currentSection,  String? sectionError)  roadsLoaded,required TResult Function( String message)  roadsFailure,required TResult Function()  equipmentsLoading,required TResult Function( List<WorkEquipment> equipments,  List<String> selectedEquipmentUids)  equipmentsLoaded,required TResult Function( String message)  equipmentsFailure,required TResult Function()  updating,required TResult Function( DailyReportResponse report)  updateSuccess,required TResult Function( String message)  updateFailure,}) {final _that = this;
switch (_that) {
case DailyReportInitial():
...
return equipmentsFailure(_that.message);case DailyReportUpdating():
return updating();case DailyReportUpdateSuccess():
return updateSuccess(_that.report);case DailyReportUpdateFailure():
return updateFailure(_that.message);case _:
  throw StateError('Unexpected subclass');
...
class DailyReportUpdating implements DailyReportState {
  const DailyReportUpdating();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DailyReportUpdating);
}
...
@override
String toString() {
  return 'DailyReportState.updating()';
}
...
class DailyReportUpdateSuccess implements DailyReportState {
  const DailyReportUpdateSuccess(this.report);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DailyReportUpdateSuccessCopyWith<DailyReportUpdateSuccess> get copyWith => _$DailyReportUpdateSuccessCopyWithImpl<DailyReportUpdateSuccess>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DailyReportUpdateSuccess&&(identical(other.report, report) || other.report == report));
}
...
@override
String toString() {
  return 'DailyReportState.updateSuccess(report: $report)';
}
...
/// @nodoc
abstract mixin class $DailyReportUpdateSuccessCopyWith<$Res> implements $DailyReportStateCopyWith<$Res> {
  factory $DailyReportUpdateSuccessCopyWith(DailyReportUpdateSuccess value, $Res Function(DailyReportUpdateSuccess) _then) = _$DailyReportUpdateSuccessCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$DailyReportUpdateSuccessCopyWithImpl<$Res>
    implements $DailyReportUpdateSuccessCopyWith<$Res> {
  _$DailyReportUpdateSuccessCopyWithImpl(this._self, this._then);

  final DailyReportUpdateSuccess _self;
  final $Res Function(DailyReportUpdateSuccess) _then;

/// Create a copy of DailyReportState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? report = null,}) {
  return _then(DailyReportUpdateSuccess(
...
class DailyReportUpdateFailure implements DailyReportState {
  const DailyReportUpdateFailure(this.message);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DailyReportUpdateFailureCopyWith<DailyReportUpdateFailure> get copyWith => _$DailyReportUpdateFailureCopyWithImpl<DailyReportUpdateFailure>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DailyReportUpdateFailure&&(identical(other.message, message) || other.message == message));
}
...
@override
String toString() {
  return 'DailyReportState.updateFailure(message: $message)';
}
...
/// @nodoc
abstract mixin class $DailyReportUpdateFailureCopyWith<$Res> implements $DailyReportStateCopyWith<$Res> {
  factory $DailyReportUpdateFailureCopyWith(DailyReportUpdateFailure value, $Res Function(DailyReportUpdateFailure) _then) = _$DailyReportUpdateFailureCopyWithImpl;
@useResult
$Res call({
 String message
});
...
/// @nodoc
class _$DailyReportUpdateFailureCopyWithImpl<$Res>
    implements $DailyReportUpdateFailureCopyWith<$Res> {
  _$DailyReportUpdateFailureCopyWithImpl(this._self, this._then);

  final DailyReportUpdateFailure _self;
  final $Res Function(DailyReportUpdateFailure) _then;

/// Create a copy of DailyReportState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? message = null,}) {
  return _then(DailyReportUpdateFailure(
null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
