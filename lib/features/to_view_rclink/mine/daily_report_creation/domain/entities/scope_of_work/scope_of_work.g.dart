...
part of 'scope_of_work.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ScopeOfWork _$ScopeOfWorkFromJson(Map<String, dynamic> json) => ScopeOfWork(
...
Map<String, dynamic> _$ScopeOfWorkToJson(ScopeOfWork instance) =>
    <String, dynamic>{
      'id': instance.id,
      'uid': instance.uid,
      'name': instance.name,
