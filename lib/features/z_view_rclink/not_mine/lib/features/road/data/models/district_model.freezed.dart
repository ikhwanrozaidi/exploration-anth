...
mixin _$DistrictModel {
 ...
 int? get id; String? get uid; String? get name; int? get stateID; ProvinceModel? get state;
...
@useResult
$Res call({
 int? id, String? uid, String? name, int? stateID, ProvinceModel? state
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? uid,  String? name,  int? stateID,  ProvinceModel? state)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DistrictModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? uid,  String? name,  int? stateID,  ProvinceModel? state)  $default,) {final _that = this;
switch (_that) {
case _DistrictModel():
return $default(_that.id,_that.uid,_that.name,_that.stateID,_that.state);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? uid,  String? name,  int? stateID,  ProvinceModel? state)?  $default,) {final _that = this;
switch (_that) {
case _DistrictModel() when $default != null:
return $default(_that.id,_that.uid,_that.name,_that.stateID,_that.state);case _:
  return null;
...
class _DistrictModel extends DistrictModel {
  const _DistrictModel({this.id, this.uid, this.name, this.stateID, this.state}): super._();
