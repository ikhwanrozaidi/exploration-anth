...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WorkEquipmentModel&&(identical(other.name, name) || other.name == name)&&(identical(other.uid, uid) || other.uid == uid));
}
...
@override
String toString() {
  return 'WorkEquipmentModel(name: $name, uid: $uid)';
}
...
class _WorkEquipmentModel implements WorkEquipmentModel {
  const _WorkEquipmentModel({required this.name, required this.uid});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WorkEquipmentModel&&(identical(other.name, name) || other.name == name)&&(identical(other.uid, uid) || other.uid == uid));
}
