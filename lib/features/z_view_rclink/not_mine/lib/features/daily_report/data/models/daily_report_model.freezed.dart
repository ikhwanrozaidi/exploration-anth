...
mixin _$DailyReportModel {
 ...
 CompanyResponseModel? get company; WorkScopeResponseModel? get workScope; RoadResponseModel? get road; CreatedByResponseModel? get createdBy; List<DailyReportEquipmentModel>? get equipments; List<ReportQuantitiesModel>? get reportQuantities; List<FileModel>? get files;// Sync fields
...
$CompanyResponseModelCopyWith<$Res>? get company;$WorkScopeResponseModelCopyWith<$Res>? get workScope;$RoadResponseModelCopyWith<$Res>? get road;$CreatedByResponseModelCopyWith<$Res>? get createdBy;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,uid,name,notes,weatherCondition,workPerformed,longitude,latitude,companyID,contractRelationID,status,approvedByID,approvedAt,rejectionReason,workScopeID,roadID,totalWorkers,fromSection,toSection,createdByID,createdAt,updatedAt,company,workScope,road,createdBy,const DeepCollectionEquality().hash(_equipments),const DeepCollectionEquality().hash(_reportQuantities),const DeepCollectionEquality().hash(_files),isSynced,deletedAt,syncAction,syncRetryCount,syncError,lastSyncAttempt]);
...
@override $CompanyResponseModelCopyWith<$Res>? get company;@override $WorkScopeResponseModelCopyWith<$Res>? get workScope;@override $RoadResponseModelCopyWith<$Res>? get road;@override $CreatedByResponseModelCopyWith<$Res>? get createdBy;
