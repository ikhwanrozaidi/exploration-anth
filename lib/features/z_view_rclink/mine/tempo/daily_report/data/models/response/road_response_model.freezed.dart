...
mixin _$RoadResponseModel {
 ...
 String? get name; String? get roadNo; String? get uid; DistrictResponseModel? get district;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RoadResponseModel&&(identical(other.name, name) || other.name == name)&&(identical(other.roadNo, roadNo) || other.roadNo == roadNo)&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.district, district) || other.district == district));
}
...
@override
String toString() {
  return 'RoadResponseModel(name: $name, roadNo: $roadNo, uid: $uid, district: $district)';
}
...
@useResult
$Res call({
 String? name, String? roadNo, String? uid, DistrictResponseModel? district
});
...
/// Create a copy of RoadResponseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = freezed,Object? roadNo = freezed,Object? uid = freezed,Object? district = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? name,  String? roadNo,  String? uid,  DistrictResponseModel? district)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RoadResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? name,  String? roadNo,  String? uid,  DistrictResponseModel? district)  $default,) {final _that = this;
switch (_that) {
case _RoadResponseModel():
return $default(_that.name,_that.roadNo,_that.uid,_that.district);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? name,  String? roadNo,  String? uid,  DistrictResponseModel? district)?  $default,) {final _that = this;
switch (_that) {
case _RoadResponseModel() when $default != null:
return $default(_that.name,_that.roadNo,_that.uid,_that.district);case _:
  return null;
...
class _RoadResponseModel extends RoadResponseModel {
  const _RoadResponseModel({this.name, this.roadNo, this.uid, this.district}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RoadResponseModel&&(identical(other.name, name) || other.name == name)&&(identical(other.roadNo, roadNo) || other.roadNo == roadNo)&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.district, district) || other.district == district));
}
...
/// Create a copy of RoadResponseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? roadNo = freezed,Object? uid = freezed,Object? district = freezed,}) {
