...
import '../../../../../tempo/location/domain/entities/road_entity.dart';
import '../../../../../tempo/daily_report/domain/entities/response/daily_report_equipment_response.dart';
import '../../../../../tempo/daily_report/domain/entities/response/daily_report_response.dart';
import '../../../../../tempo/daily_report/domain/entities/response/quantity_value_response.dart';
import '../../../../../tempo/daily_report/domain/entities/response/report_quantity_response.dart';
import '../../../../../tempo/daily_report/domain/entities/response/road_response.dart';
import '../../../../../tempo/daily_report/domain/entities/response/work_scope_response.dart';
import '../models/create/create_daily_report_equipment_model.dart';
import '../models/create/create_daily_report_model.dart';
import '../models/create/create_daily_report_quantity_model.dart';
...
abstract class DailyReportLocalDataSource {
  ...
  Future<DailyReportResponse> createDailyReportLocal(
  ...
  Future<List<Road>?> getCachedRoadsByDistrictName(String districtName);
  Future<void> cacheRoads(List<Road> roads, String districtName);
...
class DailyReportLocalDataSourceImpl implements DailyReportLocalDataSource {
  ...
  @override
  Future<List<Road>?> getCachedRoadsByDistrictName(String districtName) async {
    try {
  ...
  @override
  Future<void> cacheRoads(List<Road> roads, String districtName) async {
    try {
