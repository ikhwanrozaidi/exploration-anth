...
mixin _$DailyReportModel {
 ...
 int? get id;// Nullable - NULL during draft, set from server on first sync
 String get uid; String get name; String? get notes; String get weatherCondition; bool get workPerformed;// Location coordinates
 ...
 CompanyResponseModel? get company; WorkScopeResponseModel? get workScope; RoadResponseModel? get road; CreatedByResponseModel? get createdBy; List<DailyReportEquipmentModel>? get equipments; List<ReportQuantitiesModel>? get reportQuantities; List<FileModel>? get files; WarningResponseModel? get warning;// Sync fields
...
@useResult
$Res call({
 int? id, String uid, String name, String? notes, String weatherCondition, bool workPerformed, String? longitude, String? latitude, int companyID, int? contractRelationID, String status, int? approvedByID, DateTime? approvedAt, String? rejectionReason, int workScopeID, int roadID, int? totalWorkers, String? fromSection, String? toSection, int createdByID, DateTime createdAt, DateTime updatedAt, CompanyResponseModel? company, WorkScopeResponseModel? workScope, RoadResponseModel? road, CreatedByResponseModel? createdBy, List<DailyReportEquipmentModel>? equipments, List<ReportQuantitiesModel>? reportQuantities, List<FileModel>? files, WarningResponseModel? warning, bool isSynced, DateTime? deletedAt, String? syncAction, int syncRetryCount, String? syncError, DateTime? lastSyncAttempt
});


$CompanyResponseModelCopyWith<$Res>? get company;$WorkScopeResponseModelCopyWith<$Res>? get workScope;$RoadResponseModelCopyWith<$Res>? get road;$CreatedByResponseModelCopyWith<$Res>? get createdBy;$WarningResponseModelCopyWith<$Res>? get warning;
...
/// Create a copy of DailyReportModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? uid = null,Object? name = null,Object? notes = freezed,Object? weatherCondition = null,Object? workPerformed = null,Object? longitude = freezed,Object? latitude = freezed,Object? companyID = null,Object? contractRelationID = freezed,Object? status = null,Object? approvedByID = freezed,Object? approvedAt = freezed,Object? rejectionReason = freezed,Object? workScopeID = null,Object? roadID = null,Object? totalWorkers = freezed,Object? fromSection = freezed,Object? toSection = freezed,Object? createdByID = null,Object? createdAt = null,Object? updatedAt = null,Object? company = freezed,Object? workScope = freezed,Object? road = freezed,Object? createdBy = freezed,Object? equipments = freezed,Object? reportQuantities = freezed,Object? files = freezed,Object? warning = freezed,Object? isSynced = null,Object? deletedAt = freezed,Object? syncAction = freezed,Object? syncRetryCount = null,Object? syncError = freezed,Object? lastSyncAttempt = freezed,}) {
...
as RoadResponseModel?,createdBy: freezed == createdBy ? _self.createdBy : createdBy // ignore: cast_nullable_to_non_nullable
as CreatedByResponseModel?,equipments: freezed == equipments ? _self.equipments : equipments // ignore: cast_nullable_to_non_nullable
...
as List<FileModel>?,warning: freezed == warning ? _self.warning : warning // ignore: cast_nullable_to_non_nullable
as WarningResponseModel?,isSynced: null == isSynced ? _self.isSynced : isSynced // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$WarningResponseModelCopyWith<$Res>? get warning {
    if (_self.warning == null) {
    return null;
  }

  return $WarningResponseModelCopyWith<$Res>(_self.warning!, (value) {
...
@override final  WarningResponseModel? warning;
// Sync fields
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DailyReportModel&&(identical(other.id, id) || other.id == id)&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.name, name) || other.name == name)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.weatherCondition, weatherCondition) || other.weatherCondition == weatherCondition)&&(identical(other.workPerformed, workPerformed) || other.workPerformed == workPerformed)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.companyID, companyID) || other.companyID == companyID)&&(identical(other.contractRelationID, contractRelationID) || other.contractRelationID == contractRelationID)&&(identical(other.status, status) || other.status == status)&&(identical(other.approvedByID, approvedByID) || other.approvedByID == approvedByID)&&(identical(other.approvedAt, approvedAt) || other.approvedAt == approvedAt)&&(identical(other.rejectionReason, rejectionReason) || other.rejectionReason == rejectionReason)&&(identical(other.workScopeID, workScopeID) || other.workScopeID == workScopeID)&&(identical(other.roadID, roadID) || other.roadID == roadID)&&(identical(other.totalWorkers, totalWorkers) || other.totalWorkers == totalWorkers)&&(identical(other.fromSection, fromSection) || other.fromSection == fromSection)&&(identical(other.toSection, toSection) || other.toSection == toSection)&&(identical(other.createdByID, createdByID) || other.createdByID == createdByID)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.company, company) || other.company == company)&&(identical(other.workScope, workScope) || other.workScope == workScope)&&(identical(other.road, road) || other.road == road)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&const DeepCollectionEquality().equals(other._equipments, _equipments)&&const DeepCollectionEquality().equals(other._reportQuantities, _reportQuantities)&&const DeepCollectionEquality().equals(other._files, _files)&&(identical(other.warning, warning) || other.warning == warning)&&(identical(other.isSynced, isSynced) || other.isSynced == isSynced)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt)&&(identical(other.syncAction, syncAction) || other.syncAction == syncAction)&&(identical(other.syncRetryCount, syncRetryCount) || other.syncRetryCount == syncRetryCount)&&(identical(other.syncError, syncError) || other.syncError == syncError)&&(identical(other.lastSyncAttempt, lastSyncAttempt) || other.lastSyncAttempt == lastSyncAttempt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,uid,name,notes,weatherCondition,workPerformed,longitude,latitude,companyID,contractRelationID,status,approvedByID,approvedAt,rejectionReason,workScopeID,roadID,totalWorkers,fromSection,toSection,createdByID,createdAt,updatedAt,company,workScope,road,createdBy,const DeepCollectionEquality().hash(_equipments),const DeepCollectionEquality().hash(_reportQuantities),const DeepCollectionEquality().hash(_files),warning,isSynced,deletedAt,syncAction,syncRetryCount,syncError,lastSyncAttempt]);
...
@override $CompanyResponseModelCopyWith<$Res>? get company;@override $WorkScopeResponseModelCopyWith<$Res>? get workScope;@override $RoadResponseModelCopyWith<$Res>? get road;@override $CreatedByResponseModelCopyWith<$Res>? get createdBy;@override $WarningResponseModelCopyWith<$Res>? get warning;
...
/// Create a copy of DailyReportModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? uid = null,Object? name = null,Object? notes = freezed,Object? weatherCondition = null,Object? workPerformed = null,Object? longitude = freezed,Object? latitude = freezed,Object? companyID = null,Object? contractRelationID = freezed,Object? status = null,Object? approvedByID = freezed,Object? approvedAt = freezed,Object? rejectionReason = freezed,Object? workScopeID = null,Object? roadID = null,Object? totalWorkers = freezed,Object? fromSection = freezed,Object? toSection = freezed,Object? createdByID = null,Object? createdAt = null,Object? updatedAt = null,Object? company = freezed,Object? workScope = freezed,Object? road = freezed,Object? createdBy = freezed,Object? equipments = freezed,Object? reportQuantities = freezed,Object? files = freezed,Object? warning = freezed,Object? isSynced = null,Object? deletedAt = freezed,Object? syncAction = freezed,Object? syncRetryCount = null,Object? syncError = freezed,Object? lastSyncAttempt = freezed,}) {
...
as WorkScopeResponseModel?,road: freezed == road ? _self.road : road // ignore: cast_nullable_to_non_nullable
as RoadResponseModel?,createdBy: freezed == createdBy ? _self.createdBy : createdBy // ignore: cast_nullable_to_non_nullable
as CreatedByResponseModel?,equipments: freezed == equipments ? _self._equipments : equipments // ignore: cast_nullable_to_non_nullable
