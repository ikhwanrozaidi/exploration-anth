...
part of 'workscope_response_model.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WorkScopeResponseModel&&(identical(other.name, name) || other.name == name)&&(identical(other.code, code) || other.code == code)&&(identical(other.uid, uid) || other.uid == uid));
}
...
@override
String toString() {
  return 'WorkScopeResponseModel(name: $name, code: $code, uid: $uid)';
}
...
/// Create a copy of WorkScopeResponseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = freezed,Object? code = freezed,Object? uid = freezed,}) {
...
class _WorkScopeResponseModel extends WorkScopeResponseModel {
  const _WorkScopeResponseModel({this.name, this.code, this.uid}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WorkScopeResponseModel&&(identical(other.name, name) || other.name == name)&&(identical(other.code, code) || other.code == code)&&(identical(other.uid, uid) || other.uid == uid));
}
...
/// Create a copy of WorkScopeResponseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? code = freezed,Object? uid = freezed,}) {
