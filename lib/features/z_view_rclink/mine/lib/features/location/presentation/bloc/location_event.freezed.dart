...
return clearCache(_that);case ClearAllLocationCache() when clearAllLocationCache != null:
return clearAllLocationCache(_that);case _:
  return orElse();
...
return clearCache(_that);case ClearAllLocationCache():
return clearAllLocationCache(_that);case _:
...
return clearCache();case ClearAllLocationCache() when clearAllLocationCache != null:
return clearAllLocationCache();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String? countryUid,  bool forceRefresh)  loadProvinces,required TResult Function( String? provinceUid,  bool forceRefresh)  loadDistricts,required TResult Function( String? districtUid,  bool forceRefresh)  loadRoads,required TResult Function( String uid)  selectProvince,required TResult Function( String uid)  selectDistrict,required TResult Function( String uid)  selectRoad,required TResult Function()  clearSelections,required TResult Function()  clearCache,required TResult Function()  clearAllLocationCache,}) {final _that = this;
switch (_that) {
case LoadProvinces():
...
return clearCache();case ClearAllLocationCache():
return clearAllLocationCache();case _:
  throw StateError('Unexpected subclass');
...
class ClearAllLocationCache implements LocationEvent {
  const ClearAllLocationCache();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClearAllLocationCache);
}
...
@override
String toString() {
  return 'LocationEvent.clearAllLocationCache()';
}
