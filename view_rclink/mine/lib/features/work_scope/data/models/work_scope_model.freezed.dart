...
@override
String toString() {
  return 'WorkScopeModel(id: $id, uid: $uid, name: $name, code: $code, description: $description, allowMultipleQuantities: $allowMultipleQuantities, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, companyID: $companyID, workQuantityTypes: $workQuantityTypes, workEquipments: $workEquipments)';
}
