...
ProgramQuantity _$ProgramQuantityFromJson(Map<String, dynamic> json) =>
    ProgramQuantity(
      ...
      quantityValues: (json['quantityValues'] as List<dynamic>?)
          ?.map((e) => ProgramQuantityValue.fromJson(e as Map<String, dynamic>))
          .toList(),
      segments: (json['segments'] as List<dynamic>?)
          ?.map(
            (e) => ProgramQuantitySegment.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    );

Map<String, dynamic> _$ProgramQuantityToJson(
  ProgramQuantity instance,
) => <String, dynamic>{
  'id': instance.id,
  'uid': instance.uid,
  ...
  'quantityType': instance.quantityType?.toJson(),
  'quantityValues': instance.quantityValues?.map((e) => e.toJson()).toList(),
  'segments': instance.segments?.map((e) => e.toJson()).toList(),
};

ProgramQuantityValue _$ProgramQuantityValueFromJson(
  Map<String, dynamic> json,
) => ProgramQuantityValue(
  id: (json['id'] as num?)?.toInt(),
  ...
  quantityField: json['quantityField'] == null
      ? null
      : QuantityFieldNested.fromJson(
          json['quantityField'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ProgramQuantityValueToJson(
  ProgramQuantityValue instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'createdAt': instance.createdAt,
  'updatedAt': instance.updatedAt,
  'quantityField': instance.quantityField?.toJson(),
};

ProgramQuantitySegment _$ProgramQuantitySegmentFromJson(
  Map<String, dynamic> json,
) => ProgramQuantitySegment(
  id: (json['id'] as num?)?.toInt(),
  programQuantityID: (json['programQuantityID'] as num?)?.toInt(),
...
Map<String, dynamic> _$ProgramQuantitySegmentToJson(
  ProgramQuantitySegment instance,
) => <String, dynamic>{
  'id': instance.id,
  'programQuantityID': instance.programQuantityID,
  ...
  'createdAt': instance.createdAt,
  'updatedAt': instance.updatedAt,
  'segmentValues': instance.segmentValues?.map((e) => e.toJson()).toList(),
};
