...
part of 'contract_relation_nested_entity.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ContractRelationNested _$ContractRelationNestedFromJson(
  Map<String, dynamic> json,
) => ContractRelationNested(
  ...
  contractorCompany: json['contractorCompany'] == null
      ? null
      : ContractorCompanyNested.fromJson(
          json['contractorCompany'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ContractRelationNestedToJson(
  ContractRelationNested instance,
) => <String, dynamic>{
  'id': instance.id,
  'uid': instance.uid,
