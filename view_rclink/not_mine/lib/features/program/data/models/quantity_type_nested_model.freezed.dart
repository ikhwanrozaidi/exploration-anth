...
mixin _$QuantityTypeNestedModel {
 ...
 int? get id; String? get uid; String? get name; String? get code; String? get description; int? get workScopeID; int? get companyID; int? get displayOrder; bool? get isActive; bool? get hasSegmentBreakdown; int? get segmentSize; int? get maxSegmentLength; String? get createdAt; String? get updatedAt; String? get deletedAt; List<QuantityFieldNestedModel>? get quantityFields;// For programSettingID relationship (from API response)
 int? get programSettingID; int? get quantityTypeID; int? get settingDisplayOrder; bool? get isRequiredInSetting;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QuantityTypeNestedModel&&(identical(other.id, id) || other.id == id)&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.name, name) || other.name == name)&&(identical(other.code, code) || other.code == code)&&(identical(other.description, description) || other.description == description)&&(identical(other.workScopeID, workScopeID) || other.workScopeID == workScopeID)&&(identical(other.companyID, companyID) || other.companyID == companyID)&&(identical(other.displayOrder, displayOrder) || other.displayOrder == displayOrder)&&(identical(other.isActive, isActive) || other.isActive == isActive)&&(identical(other.hasSegmentBreakdown, hasSegmentBreakdown) || other.hasSegmentBreakdown == hasSegmentBreakdown)&&(identical(other.segmentSize, segmentSize) || other.segmentSize == segmentSize)&&(identical(other.maxSegmentLength, maxSegmentLength) || other.maxSegmentLength == maxSegmentLength)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt)&&const DeepCollectionEquality().equals(other.quantityFields, quantityFields)&&(identical(other.programSettingID, programSettingID) || other.programSettingID == programSettingID)&&(identical(other.quantityTypeID, quantityTypeID) || other.quantityTypeID == quantityTypeID)&&(identical(other.settingDisplayOrder, settingDisplayOrder) || other.settingDisplayOrder == settingDisplayOrder)&&(identical(other.isRequiredInSetting, isRequiredInSetting) || other.isRequiredInSetting == isRequiredInSetting));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,uid,name,code,description,workScopeID,companyID,displayOrder,isActive,hasSegmentBreakdown,segmentSize,maxSegmentLength,createdAt,updatedAt,deletedAt,const DeepCollectionEquality().hash(quantityFields),programSettingID,quantityTypeID,settingDisplayOrder,isRequiredInSetting]);

@override
String toString() {
  return 'QuantityTypeNestedModel(id: $id, uid: $uid, name: $name, code: $code, description: $description, workScopeID: $workScopeID, companyID: $companyID, displayOrder: $displayOrder, isActive: $isActive, hasSegmentBreakdown: $hasSegmentBreakdown, segmentSize: $segmentSize, maxSegmentLength: $maxSegmentLength, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, quantityFields: $quantityFields, programSettingID: $programSettingID, quantityTypeID: $quantityTypeID, settingDisplayOrder: $settingDisplayOrder, isRequiredInSetting: $isRequiredInSetting)';
}
...
@useResult
$Res call({
 int? id, String? uid, String? name, String? code, String? description, int? workScopeID, int? companyID, int? displayOrder, bool? isActive, bool? hasSegmentBreakdown, int? segmentSize, int? maxSegmentLength, String? createdAt, String? updatedAt, String? deletedAt, List<QuantityFieldNestedModel>? quantityFields, int? programSettingID, int? quantityTypeID, int? settingDisplayOrder, bool? isRequiredInSetting
});
...
/// Create a copy of QuantityTypeNestedModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? uid = freezed,Object? name = freezed,Object? code = freezed,Object? description = freezed,Object? workScopeID = freezed,Object? companyID = freezed,Object? displayOrder = freezed,Object? isActive = freezed,Object? hasSegmentBreakdown = freezed,Object? segmentSize = freezed,Object? maxSegmentLength = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? deletedAt = freezed,Object? quantityFields = freezed,Object? programSettingID = freezed,Object? quantityTypeID = freezed,Object? settingDisplayOrder = freezed,Object? isRequiredInSetting = freezed,}) {
...
as List<QuantityFieldNestedModel>?,programSettingID: freezed == programSettingID ? _self.programSettingID : programSettingID // ignore: cast_nullable_to_non_nullable
as int?,quantityTypeID: freezed == quantityTypeID ? _self.quantityTypeID : quantityTypeID // ignore: cast_nullable_to_non_nullable
as int?,settingDisplayOrder: freezed == settingDisplayOrder ? _self.settingDisplayOrder : settingDisplayOrder // ignore: cast_nullable_to_non_nullable
as int?,isRequiredInSetting: freezed == isRequiredInSetting ? _self.isRequiredInSetting : isRequiredInSetting // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? uid,  String? name,  String? code,  String? description,  int? workScopeID,  int? companyID,  int? displayOrder,  bool? isActive,  bool? hasSegmentBreakdown,  int? segmentSize,  int? maxSegmentLength,  String? createdAt,  String? updatedAt,  String? deletedAt,  List<QuantityFieldNestedModel>? quantityFields,  int? programSettingID,  int? quantityTypeID,  int? settingDisplayOrder,  bool? isRequiredInSetting)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QuantityTypeNestedModel() when $default != null:
return $default(_that.id,_that.uid,_that.name,_that.code,_that.description,_that.workScopeID,_that.companyID,_that.displayOrder,_that.isActive,_that.hasSegmentBreakdown,_that.segmentSize,_that.maxSegmentLength,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.quantityFields,_that.programSettingID,_that.quantityTypeID,_that.settingDisplayOrder,_that.isRequiredInSetting);case _:
  return orElse();
...
class _QuantityTypeNestedModel implements QuantityTypeNestedModel {
  const _QuantityTypeNestedModel({this.id, this.uid, this.name, this.code, this.description, this.workScopeID, this.companyID, this.displayOrder, this.isActive, this.hasSegmentBreakdown, this.segmentSize, this.maxSegmentLength, this.createdAt, this.updatedAt, this.deletedAt, final  List<QuantityFieldNestedModel>? quantityFields, this.programSettingID, this.quantityTypeID, this.settingDisplayOrder, this.isRequiredInSetting}): _quantityFields = quantityFields;
...
// For programSettingID relationship (from API response)
@override final  int? programSettingID;
@override final  int? quantityTypeID;
@override final  int? settingDisplayOrder;
@override final  bool? isRequiredInSetting;
