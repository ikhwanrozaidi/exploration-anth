...
_QuantityTypeNestedModel _$QuantityTypeNestedModelFromJson(
  ...
  quantityFields: (json['quantityFields'] as List<dynamic>?)
      ?.map((e) => QuantityFieldNestedModel.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$QuantityTypeNestedModelToJson(
  _QuantityTypeNestedModel instance,
) => <String, dynamic>{
  'id': instance.id,
  'uid': instance.uid,
  'name': instance.name,
