...
_ProgramSettingModel _$ProgramSettingModelFromJson(Map<String, dynamic> json) =>
    _ProgramSettingModel(
      ...
      quantityTypes: (json['quantityTypes'] as List<dynamic>?)
          ?.map(
            (e) => QuantityTypeNestedModel.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    );

Map<String, dynamic> _$ProgramSettingModelToJson(
  _ProgramSettingModel instance,
) => <String, dynamic>{
  'id': instance.id,
  'uid': instance.uid,
