...
class _DistrictResponseModel implements DistrictResponseModel {
  const _DistrictResponseModel({required this.name, required this.uid, this.state});
...
class _StateResponseModel implements StateResponseModel {
  const _StateResponseModel({required this.name, required this.uid, this.country});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CountryResponseModel&&(identical(other.name, name) || other.name == name)&&(identical(other.uid, uid) || other.uid == uid));
}
...
@override
String toString() {
  return 'CountryResponseModel(name: $name, uid: $uid)';
}
...
class _CountryResponseModel implements CountryResponseModel {
  const _CountryResponseModel({required this.name, required this.uid});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CountryResponseModel&&(identical(other.name, name) || other.name == name)&&(identical(other.uid, uid) || other.uid == uid));
}
