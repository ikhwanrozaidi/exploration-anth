...
import '../bloc/create_warning/create_warning_bloc.dart';
import '../bloc/create_warning/create_warning_event.dart';
import '../bloc/create_warning/create_warning_state.dart';
...
class _WarningReportReviewPageState extends State<WarningReportReviewPage> {
  ...
  bool get _hasSelectedWarnings {
    return _selectedWarningsByCategory.values.any(
      (selections) => selections.isNotEmpty,
    );
  }

  int get _totalSelectedCount {
    return _selectedWarningsByCategory.values.fold(
      0,
  ...
  IconData _getIconForCategory(String categoryName) {
    ...
    if (normalizedName.contains('quality') || normalizedName.contains('work')) {
                ...
                return CheckboxListTile(
                  ...
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      if (value == true) {
                        _selectedWarningsByCategory[categoryUID]!.add(
                          reasonUID,
                        );
                      } else {
                        _selectedWarningsByCategory[categoryUID]!.remove(
                          reasonUID,
                        );
                      }
                    });
                            ...
                            builder: (context, state) {
                              return state.when(
                                ...
                                loaded: (categories) {
                                  ...
                                  final reportWorkScopeID =
                                      widget.report.workScopeID;
